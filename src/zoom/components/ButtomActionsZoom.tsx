import { faDisplay, faGear, faImage, faMicrophone, faMicrophoneSlash, faUserPlus } from "@fortawesome/free-solid-svg-icons"
...
const ButtonsActionsZoom = ({ isScreenCaptureActive, toggleScreenCapture }: Props) => {
...
export default ButtonsActionsZoom